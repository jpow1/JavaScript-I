...
let carModels = ["Lincoln", "Mazda", "Land Rover", "Honda", "Mitsubishi", "Smart", "Audi", "Ford", "Mercedes-Benz", "Lotus", "Chevrolet", "Infiniti", "Dodge", "Oldsmobile", "Geo", "Jeep", "BMW", "Cadillac", "Pontiac", "Volvo", "Chrysler", "GMC", "Lincoln"];
...
for (let i = 0; i < inventory.length; i++){
  let mappedObj ={};
  mappedObj.car_year = inventory[i].car_year;
  carYears.push(mappedObj);
  mappedObj = {}
}
